...
func (p *Podcast) GetTitulo() string       { return p.titulo }
func (p *Podcast) SetTitulo(titulo string) { p.titulo = titulo }
...
func (p *Podcast) SetClasificacionContenido(clasificacion string) {
	p.clasificacionContenido = clasificacion
}
